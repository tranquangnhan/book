                        ...
                        <div class="col-md-12 about-intro">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="#">Sách giáo viên tập 1</a>
                                    ...
                                    <div class="owl-carousel owl-theme slide-video" id="kind-carousel">
                                        <div class="item slide-video-item">
                                            <div class="w-100 d-flex align-items-stretch ftco-animate">
                                                <div class="project-wrap">
                                                    <a href="#" class="img-product position-relative"
                                                        style="background-image: url(<?=PATH_URL?>images/S6-AB.png);">
                                                        <span class="price">Sách</span>
                                                    </a>
                                                    <div class="text p-4">
                                                        <h3><a href="course-detail.html">Smiles 1 Special
                                                                Edition</a></h3>
                                        ...
                                        <div class="item slide-video-item">
                                            <div class="w-100 d-flex align-items-stretch ftco-animate">
                                                <div class="project-wrap">
                                                    <a href="#" class="img-product position-relative"
                                                        style="background-image: url(<?=PATH_URL?>images/S2-AB.png);">
                                                        <span class="price">Sách</span>
                                                    </a>
                                                    <div class="text p-4">
                                                        <h3><a href="course-detail.html">Smiles 1 Special
