        ...
        <div class="row">
            <div class="col-lg-9">
                    ...
                    <div class="container" style="width: fit-content; margin-bottom: 5%;">
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-primary active font-weight-600">
                                <input type="radio" name="options" id="option1" autocomplete="off" checked>Học Sinh
                            </label>
                            <label class="btn btn-dark font-weight-600">
                                <input type="radio" name="options" id="option2" autocomplete="off"> Giáo Viên
                ...
                <div class="col-lg-12">
                    <div class="container" style="width: fit-content; margin-bottom: 5%;">
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-secondary active font-weight-600">
                                <input type="radio" name="options" id="option1" autocomplete="off" checked>Sách
                                Giáo Khoa
                            </label>
                            <label class="btn btn-dark font-weight-600">
                                <input type="radio" name="options" id="option2" autocomplete="off"> Sách Tham Khảo
                                - Bổ Trợ

                            </label>
                            <label class="btn btn-dark font-weight-600">
                                <input type="radio" name="options" id="option3" autocomplete="off"> Sách Tăng
                                Cường
                            </label>
                        </div>
                    </div>
